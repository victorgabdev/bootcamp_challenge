package challenges.oopBasic.challenge2;
...
Desligar o carro; (ok)
Acelerar; (ok)
diminuir velocidade; (OK)
virar para esquerda/direita (OK)
verificar velocidade;
trocar a marcha
Siga as seguintes regras na implementação

Quando o carro for criado ele deve começar desligado, em ponto morto e com sua velocidade em 0 (OK)
